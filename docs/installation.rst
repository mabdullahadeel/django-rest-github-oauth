...
To install django-rest-github-oauth, run this command in your terminal:
...
The sources for django-rest-github-oauth can be downloaded from the `Github repo`_.
